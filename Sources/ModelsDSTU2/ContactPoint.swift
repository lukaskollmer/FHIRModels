...
//  HealthSoftware
//
//  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/ContactPoint)
...
/**
 ...
 etc.
 */
public struct ContactPoint: Element {
	...
	/// Restricted to: ['phone', 'fax', 'email', 'pager', 'other']
	public var system: FHIRPrimitive<ContactPointSystem>?
	
	/// Identifies the purpose for the contact point.
	/// Restricted to: ['home', 'work', 'temp', 'old', 'mobile']
