...
//  HealthSoftware
//
//  Generated from FHIR 3.0.2.11917 (http://hl7.org/fhir/StructureDefinition/AllergyIntolerance)
...
public struct AllergyIntolerance: DomainResource {
	...
	public var clinicalStatus: FHIRPrimitive<AllergyIntoleranceClinicalStatus>?
	...
	public init(
		...
		clinicalStatus: FHIRPrimitive<AllergyIntoleranceClinicalStatus>? = nil,
	...
	public init(from decoder: Decoder) throws {
		...
		self.clinicalStatus = try FHIRPrimitive<AllergyIntoleranceClinicalStatus>(from: _container, forKeyIfPresent: .clinicalStatus, auxiliaryKey: ._clinicalStatus)
