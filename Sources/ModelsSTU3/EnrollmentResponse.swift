...
//  HealthSoftware
//
//  Generated from FHIR 3.0.2.11917 (http://hl7.org/fhir/StructureDefinition/EnrollmentResponse)
 ...
 */
public struct EnrollmentResponse: DomainResource {
	
	public static let resourceType: ResourceType = .enrollmentResponse
