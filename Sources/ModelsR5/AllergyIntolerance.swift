...
//  HealthSoftware
//
//  Generated from FHIR 5.0.0 (http://hl7.org/fhir/StructureDefinition/AllergyIntolerance)
 ...
 */
public struct AllergyIntoleranceParticipant: BackboneElement {
...
public struct AllergyIntoleranceReaction: BackboneElement {
	...
	/// Designated initializer taking all required properties
	public init(manifestation: [CodeableReference]) {
