...
//  HealthSoftware
//
//  Generated from FHIR 6.0.0-ballot4 (http://hl7.org/fhir/StructureDefinition/Basic)
 ...
 */
public struct Basic: DomainResource {
	
	public static let resourceType: ResourceType = .basic
