...
public indirect enum RequestStatus: String, FHIRPrimitiveType {
	...
	/// This request is no longer to be acted upon. This status does not differentiate what degree of action (if any)
	/// has already been undertaken against the request.
	case ended
