...
//  HealthSoftware
//
//  Generated from FHIR 6.0.0-ballot4 (http://hl7.org/fhir/StructureDefinition/Group)
...
public struct GroupCharacteristic: BackboneElement {
	...
	public init(from decoder: Decoder) throws {
		...
		self.id = try FHIRPrimitive<FHIRString>(from: _container, forKeyIfPresent: .id, auxiliaryKey: ._id)
		self.instances = try Self._decodeInstances(from: _container)
	...
	private static func _decodeInstances(
		from _container: KeyedDecodingContainer<CodingKeys>
	) throws -> InstancesX? {
