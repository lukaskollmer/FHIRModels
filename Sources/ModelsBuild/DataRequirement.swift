...
//  HealthSoftware
//
//  Generated from FHIR 6.0.0-ballot4 (http://hl7.org/fhir/StructureDefinition/DataRequirement)
...
/**
 ...
 the data.
 */
public struct DataRequirement: DataType {
 ...
 */
public struct DataRequirementValueFilter: Element {
