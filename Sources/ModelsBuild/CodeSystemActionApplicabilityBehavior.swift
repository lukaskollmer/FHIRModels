...
public indirect enum ActionApplicabilityBehavior: String, FHIRPrimitiveType {
	...
	/// The applicability of each action is evaluated in order; the first action for which the applicability criteria
	/// evaluates to true is applied, and processing of the parent action stops.
	case any
}
