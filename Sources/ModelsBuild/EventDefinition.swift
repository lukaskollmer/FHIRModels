...
//  HealthSoftware
//
//  Generated from FHIR 6.0.0-ballot4 (http://hl7.org/fhir/StructureDefinition/EventDefinition)
 ...
 */
public struct EventDefinition: DomainResource {
	
	public static let resourceType: ResourceType = .eventDefinition
