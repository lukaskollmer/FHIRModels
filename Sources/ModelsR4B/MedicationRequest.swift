...
//  HealthSoftware
//
//  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/MedicationRequest)
...
public struct MedicationRequest: DomainResource {
	...
	public init(intent: FHIRPrimitive<MedicationRequestIntentCodes>, medication: MedicationX, status: FHIRPrimitive<MedicationRequestStatusCodes>, subject: Reference) {
		self.intent = intent
