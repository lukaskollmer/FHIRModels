...
//  HealthSoftware
//
//  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/CoverageEligibilityResponse)
...
public struct CoverageEligibilityResponse: DomainResource {
	...
	public init(created: FHIRPrimitive<DateTime>, insurer: Reference, outcome: FHIRPrimitive<FHIRString>, patient: Reference, purpose: [FHIRPrimitive<EligibilityResponsePurpose>], request: Reference, status: FHIRPrimitive<FinancialResourceStatusCodes>) {
