...
//  HealthSoftware
//
//  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/NutritionOrder)
...
public struct NutritionOrder: DomainResource {
	...
	public init(dateTime: FHIRPrimitive<DateTime>, intent: FHIRPrimitive<FHIRString>, patient: Reference, status: FHIRPrimitive<FHIRString>) {
